...
const HomePage: React.FC<{ onNavigate: (page: string) => void }> = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-0 pb-20 overflow-hidden">
      {/* Hero Section */}
      <section
        className="relative min-h-[560px] md:min-h-[780px] flex items-center justify-center overflow-hidden"
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl -mt-12 md:mt-0">
          <div className="inline-block px-5 py-2 md:px-10 md:py-4 bg-[#EAFF00] border-2 border-black rounded-full text-2xl md:text-5xl font-black mb-5 md:mb-10 tracking-tighter text-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            가로등기초 · 맨홀 전문
          </div>

          <h1 className="text-5xl md:text-7xl font-black mb-4 md:mb-8 tracking-tighter leading-tight drop-shadow-2xl">
            <span className="block mb-1 md:mb-2">현장 맞춤 제작</span>
            <span className="block text-blue-400">전국 납품 상담</span>
          </h1>

          <p className="text-lg md:text-2xl mb-5 text-blue-100/85 font-light max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mt-2">
            <button
              onClick={() =>
                window.open(
                  'https://smartstore.naver.com/isuindustry',
                  '_blank',
                  'noopener,noreferrer'
                )
              }
              className="group px-10 py-5 bg-[#03C75A] hover:bg-[#02b350] text-white rounded-xl font-black text-lg transition-all duration-200 flex items-center justify-center gap-3 shadow-2xl hover:-translate-y-1 hover:shadow-[0_18px_36px_rgba(0,0,0,0.28)] active:scale-95 active:translate-y-[1px]"
            >
              <ShoppingBag
                size={22}
                className="transition-transform duration-200 group-hover:rotate-[-10deg] group-hover:scale-110 group-active:scale-95"
              />
              네이버 스토어 바로가기
            </button>
          </div>
      ...
      <section className="bg-gray-50 py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-center text-4xl font-black text-slate-900 mb-4">이수산업의 제품</h2>

          <div className="w-16 h-1.5 bg-blue-900 mx-auto rounded-full mb-14" />

          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img src="/images/manhole.jpg" className="w-full h-64 object-cover" />
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img src="/images/lightbase.jpg" className="w-full h-64 object-cover" />
              <div className="p-7 text-center">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img src="/images/foundation.jpg" className="w-full h-64 object-cover" />
              <div className="p-7 text-center">
      ...
      <section className="relative pt-32 pb-20 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <div
              className="w-12 h-1.5 bg-blue-600 mx-auto rounded-full mb-6"
              style={{ backgroundColor: config.primaryColor }}
            />
            <p className="text-gray-500 font-medium text-lg">
              수만 건의 시공 경험으로 증명된 가로등기초 및 맨홀 전문성
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="group bg-white p-10 rounded-[40px] border border-gray-100 shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:border-blue-100 transition-all duration-500 flex flex-col items-start text-left"
              >
                <div
                ...
                <h3 className="text-2xl font-black mb-4 tracking-tight text-gray-900 group-hover:text-blue-600 transition-colors">
                  {item.title}
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-24">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tighter">
              왜 <span style={{ color: config.primaryColor }}>이수산업</span>을 선택해야 하는가?
            </h2>
            <div
              className="w-12 h-1.5 bg-blue-600 mx-auto mt-8 rounded-full"
              style={{ backgroundColor: config.primaryColor }}
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div
                key={idx}
                className="bg-white/80 backdrop-blur-sm p-12 rounded-[40px] shadow-lg border border-white hover:border-blue-200 hover:shadow-2xl transition-all group relative overflow-hidden"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20">
        <div
          className="bg-slate-900 rounded-[50px] p-16 text-white flex flex-col lg:flex-row items-center justify-between gap-16 shadow-2xl border border-white/5 relative overflow-hidden"
          style={{ backgroundColor: config.primaryColor }}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-transparent pointer-events-none" />

          <div className="max-w-md text-center lg:text-left relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 rounded-lg text-blue-300 text-[10px] font-bold mb-6 uppercase tracking-widest">
              Performance Stats
            </div>
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-16 relative z-10">
            {[
              ...
              <div key={idx} className="relative group">
                <div className="absolute -left-6 top-0 bottom-0 w-1.5 bg-blue-500 rounded-full opacity-30 group-hover:opacity-100 transition-opacity" />
                <span className="block text-4xl md:text-5xl font-black mb-2 tracking-tighter text-white">
                  {stat.value}
                </span>
                <span className="text-blue-300/80 text-xs font-bold uppercase tracking-widest">
                  {stat.label}
                </span>
              </div>
            ))}
